...
int main(void) {
  ...
  tcase_add_test(tc, test_normal1);
  tcase_add_test(tc, test_not_sqare1);
  tcase_add_test(tc, test_incorrect1);
  tcase_add_test(tc, test_one_by_one1);
